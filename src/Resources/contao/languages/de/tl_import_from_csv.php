...
$GLOBALS['TL_LANG']['tl_import_from_csv']['enableCron'] = ["Cron aktivieren", "Aktivieren Sie den Import als Cronjob."];
$GLOBALS['TL_LANG']['tl_import_from_csv']['cronLevel'] = ["Cron Level", "Bestimmen Sie in welchenm Intervall die Cronjobs durchgeführt werden sollen."];
